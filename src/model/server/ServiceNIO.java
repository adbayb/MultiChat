...
public class ServiceNIO {
	...
	public void serviceAccept(Selector selecteur, SelectionKey key) {
		...
		try {
			socketChannel = serveurChannel.accept();
			if(socketChannel != null) {
				...
				String welcomeMsg = "Welcome to ADIB and SARR Tchat [version 1.0] (" + socketChannel.getLocalAddress() + ")" + "\n";
				socketChannel.write(this.charset.newEncoder().encode(CharBuffer.wrap(welcomeMsg)));
				//buffer.rewind();
	...
	public void serviceLecture(Selector selecteur, SelectionKey key){
	...
	private void diffusionMessage(Selector selecteur, String msg, SocketChannel excludeChannel) {
	...
	private String convertirByteBuffer(ByteBuffer bbf){
